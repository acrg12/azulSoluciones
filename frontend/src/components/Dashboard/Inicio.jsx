...
//const datos6 = JSON.parse(localStorage.getItem("user"));
 ...
 const fetchData6 = async () => {
   try {
     const response = await fetch(`http://5.189.133.32:9060/datasnap/rest/TServerMethods/CompraPeriodos/${datos.EMP_TERCERO}`, 
     {
       method: "GET",
       headers: {
         "Content-Type": "application/json",
        ...
        <div className="col-md-6 col-xl-3 " id="cards-1">
              ...
              >
                <div>
                  ...
                  <br />
                  <p>
                    Total compras del dia: ${Totalcompraxhora.toLocaleString()}
                  </p>
                  <br />
                  <div className="stat-cards-info">
                    <p className="stat-cards-info__title"></p>
            ...
            <div className="col-md-6 col-xl-3 " id="cards-1">
              ...
              >
                <div>
                  ...
                  <br />
                  <p>
                    Total compras última semana: ${TotalCompraUltimaSemana.toLocaleString()}
                  </p>
                  <br />
                  <div className="stat-cards-info">
                    <p className="stat-cards-info__title"></p>
